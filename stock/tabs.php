...
<div class="container1" id="fix">
	<ul class="tabs">
        <li class=""><a href="#tab1"><img src="<?php echo WEB_ROOT; ?>images/slowConsume.png"  width="36" height="36" style="padding-top:5px; padding-right:5px;"/>Slow Stock </a></li>
        <!--<li class=""><a href="#tab2"><img src="<?php echo WEB_ROOT; ?>images/fastConsume.png"  width="36" height="36" style="padding-top:5px; padding-right:5px;"/>Fast Stock</a></li>
		-->
    </ul>
    <div class="tab_container">
        <div style="display: none;" id="tab1" class="tab_content">
      	<p>Following are the List of Available Products</p>
...
?>
  ...
  <tr> 
   <td colspan="5" align="right"><input name="btnAddUser" type="button" id="btnAddUser" value="Add New Product (+)" class="button" onClick="addSoftware()"></td>
  </tr>
 </table>
 <p>&nbsp;</p>
</form>
