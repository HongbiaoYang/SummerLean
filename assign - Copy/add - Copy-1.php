...
$hwsql =  "SELECT id, hw_name
	        FROM tbl_hardwares;";
			
$hwresult = dbQuery($hwsql);
 ...
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  ...
  <tr> 
   ...
   <td class="content"> <select name="entity"  onchange="showType(this.value);">
		<option value="1">&nbsp;Slow Comsume&nbsp;</option>
		<option value="2">&nbsp;Fast Consume&nbsp;</option>
	</select></td>
  </tr>
  <tr>
	...
	<?php
	while ($row = dbFetchAssoc($hwresult)) {
		extract($row);
	?>
	<option value="<?php echo $id; ?>"><?php echo $hw_name?></option>
	<?php
	}
	?>	
	</td>
